...
module.exports = class API {
    ...
    static async addTrainerCourse(req, res) {
        try {
            ...
            const trainer = await Trainer.findById(trainerId, idProjection(Trainer), null).populate('courses').exec();
    ...
    static async deleteTrainerCourse(req, res) {
        try {
            ...
            const trainer = await Trainer.findOne({ _id: trainerId }, idProjection(Trainer), null).populate("courses").exec();
    ...
    static async deleteTrainerSessionBy_Id(req, res) {
        try {
            ...
            const trainer = await Trainer.findOne({ username: username }, idProjection(Trainer), null).populate('sessions').exec();
